...
export const RINGS: RingSpec[] = [
  ...
  { radius: 1.65, tube: 0.016, color: "#00e5b0", intensity: 2.8, speed:  0.42, axis: [0.5, 0.5, 0  ], tilt: [0.3,  0,    0.2 ], tubeSeg: 155, sectionId: "teal-outer",      sectionLabel: "// SYSTEMS"          },
  ...
  { radius: 1.38, tube: 0.018, color: "#00ff88", intensity: 3.2, speed: -0.55, axis: [1,   0,   0.5], tilt: [-0.2, 0.3,  0   ], tubeSeg: 145, sectionId: "teal-inner",      sectionLabel: "// GRID"             },
